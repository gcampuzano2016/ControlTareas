<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="ListaVacacionesPermiso.aspx.cs" Inherits="ReporteTareas.Formulario.ListaVacacionesPermiso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/ProcesoConvenio.js?v=24" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper" style="padding: 0px">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-4">
                                                                    ...
                                                                    <select id="cmbUsuarios2" class="form-control" onclick="ObtenerUsuario()">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-lg-3">
                                                                    <label>Filtros</label>
                                                                    <select id="cboFitros" class="form-control">
                                                                        <option value="1">Fecha Registro</option>
                                                                        <option value="2">Fecha Salida</option>
                                                                    </select>
                                                                    <p class="help-block"></p>
                                                                </div>
                                                            </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-2">
                                                <button id="btnConsultaVacaciones" onclick="CargarDetalleVacaciones()" type="button" class="btn btn-primary">Consultar</button>
                                            </div>
                                        </div>
                                        <div class="row">
        ...
        <div class="modal fade" id="modalEnvioMail" tabindex="-1" role="dialog" aria-labelledby="modalCargarProcesoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" id="modalEnvioMailTipo">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
