<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="RegistroForeCast.aspx.cs" Inherits="ReporteTareas.Formulario.RegistroForeCast" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/RegistroForeCast.js?v=3" type="text/javascript"></script>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="home-pills">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div id="TipoProyecto" class="form-group col-lg-2">
                                                <label>Tipo Proyecto</label>
                                                <select id="cboTipoProyecto" class="form-control">
                                            ...
                                            <div class="form-group col-lg-2">
                                                <label>Fecha Est. de Cierre</label>
                                                <input type="text" class="form-control" id="txtFechaFacturacionProyecto" placeholder="Fecha Estimado de Cierre">
                                                <p class="help-block"></p>
                                            </div>
                                            <div class="form-group col-lg-1">
                                                <button type="button" title="Agregar Comentario" class="btn btn-sm btn-success"><i class="fa fa-comment-o" aria-hidden="true" onclick="CargarObservacion()"></i></button>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-2">
                                                <label>Fecha Facturación</label>
                                                <input type="text" class="form-control" id="txtFechaInicioProyecto" placeholder="Fecha Facturación">
                                                <p class="help-block"></p>
                                            </div>
                                            <div class="form-group col-lg-2" style="display: none">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <textarea class="form-control" id="txtObservacion" name="txtObservacion" rows="2" cols="50" oninput="BuscarEmpleadoPrincipal()"></textarea>
                                                <ul class="typeahead dropdown-menu" role="listbox" style="top: 85px; left: 10px;" id="comboEmpleadoPrincipal">
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-2">
                                                <label>PRSD</label>
                                                <input class="form-check-input" type="checkbox" value="" id="IdPRSD">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-lg-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="IdDocumento" class="form-group col-lg-8" style="display: none">
                                                <form role="form">
                                                    <div class="col-lg-8">
                            ...
                            <div class="tab-pane fade" id="profile-pills">
                                <asp:Panel ID="Panel6" runat="server" Visible="true" Enabled="true">
                                    <div class="col-lg-12" style="padding: 0px">
                                        <div class="panel panel-default" style="display: block" id="OcultarFiltros">
                                            <div class="panel-heading">
                                                Filtros
                                            </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="form-group col-lg-3">
                                                        <label>Gerente Producto</label>
                                                        <select id="cboGerente2" class="js-example-basic-multiple7" name="sucursal[]" multiple="multiple" onchange="CargarMarcasGerente()">
                                                        </select>
                                                        <p class="help-block"></p>
                                                    </div>
                                                    <div class="form-group col-lg-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-2">
                                                        <label>Mes</label>
                                                        <select id="cboFecha1Buscar" class="js-example-basic-multiple4" name="facturacion[]" multiple="multiple" onchange="ObtenerSemanadelMes()">
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-lg-3">
                                                        <label>Semana</label>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-2">
                                                        <label>Proyecto Prioridad</label>
                                                        <input class="form-check-input" type="checkbox" value="" id="idFiltroPrioridad" onchange="SeleccionarPrioridad()">
                                                    </div>
                                                    <div id="TipoProyecto2" class="form-group col-lg-2">
                                                        <label>Tipo Proyecto</label>
                                                        <select id="cboTipoProyecto2" class="form-control">
                                                            <option value="SELECCIONAR">SELECCIONAR</option>
                                                            <option value="HARDWARE">HARDWARE</option>
                                                            <option value="INTANGIBLE">INTANGIBLE</option>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-2" style="display: none" id="ProyectoExtra">
                                                        <label>Proyecto Estrategico</label>
                                                        <input class="form-check-input" type="checkbox" value="" id="idFiltroEstrategico" onchange="SeleccionarEstrategico()">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel-footer">
                                                <div class="" style="text-align: center">
                                                    ...
                                                    <button id="btnDescargarPersonalizado" onclick="BtnDescargaForeCastPersonalizado()" type="button" class="btn btn-primary">Descargar XLS Personalizado</button>
                                                    <button id="btnDescargarGerencia" onclick="BtnDescargaForeCastGerencia()" type="button" class="btn btn-primary">Descargar XLS Gerencia</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12" style="padding: 0px">
                                        <div class="col-lg-12" style="padding: 20px">
                                            ...
                                            <div class="form-group col-lg-3">
                                                <button id="btnFiltros" onclick="BtnRegresarFiltros()" type="button" class="btn btn-primary">Regresar a los Filtros</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--<br />
        ...
        <div class="modal fade" id="modalMensajeObservacion" tabindex="-1" role="dialog" aria-labelledby="modalMensajeAprobarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="divMensajeObservacion" style="height: 200px">
                        <div class="form-group col-lg-12">
                            <label>Descripción:</label>
                            <!--<input type="text" class="form-control" id="txtObservacionReq">-->
                            <textarea class="form-control" id="txtObservacionProceso" name="txtObservacionProceso" rows="4" cols="50" maxlength="255" oninput="BuscarEmpleado()"></textarea>
                            <ul class="typeahead dropdown-menu" role="listbox" style="top: 65px; left: 10px;" id="comboEmpleado">
                            </ul>
                            <p class="help-block"></p>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="text" class="form-control" style="display: none;" id="txtCodigoForeCast">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        <button type="button" id="btnAceptarObser" onclick="GuardarObservacion()" class="btn btn-primary">Guardar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
        ...
        <div class="modal fade" id="modalMensajeVerObservacion" tabindex="-1" role="dialog" aria-labelledby="modalMensajeAprobarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="divMensajeVerObservacion" style="height: 400px">
                        <div class="form-group col-lg-12">
                            <label id="MensajeForeCast"></label>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade" id="modalMensajeComentario" tabindex="-1" role="dialog" aria-labelledby="modalMensajeAprobarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="divMensajeComentario" style="height: 200px">
                        <div class="form-group col-lg-12">
                            <label>Descripción:</label>
                            <!--<input type="text" class="form-control" id="txtObservacionReq">-->
                            <textarea class="form-control" id="txtComentarioProceso" name="txtObservacionProces" rows="4" cols="50" maxlength="255"></textarea>
