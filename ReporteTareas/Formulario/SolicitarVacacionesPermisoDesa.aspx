<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="SolicitarVacacionesPermisoDesa.aspx.cs" Inherits="ReporteTareas.Formulario.SolicitarVacacionesPermisoDesa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	...
	<script src="../js/Convenio.js?v=1" type="text/javascript"></script>	
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	<div id="page-wrapper" style="padding: 0px">
														...
														<div class="panel-body">
															<div class="col-lg-12">
																...
																<div class="form-group col-lg-12">
																	...
																	<select id="txtReemplazo" class="js-example-basic-multiple" name="mercado[]" multiple="multiple">
																	</select>																	
																	<!--<input type="text" class="form-control" id="txtReemplazo">-->
																</div>
																<div class="form-group col-lg-12" style="display:block" id="Vacaciones">																
																	<div class="col-lg-3">
																...
																<div class="form-group col-lg-12" style="display:none" id="Planificacion">
																	<div id="table-datosTablaPrincipal3" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
																		<div class="row">                                    
        ...
        <div class="modal fade" id="modalCargarProceso" tabindex="-1" role="dialog" aria-labelledby="modalCargarProcesoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" id="modalCargarProcesoTipo">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
