...
namespace WinCorreo
{
    public class ClsEnvioCorreo
    {
        ...
        public void EnvioCorreo()
        {
            ...
            {
                if(entTareas.MailResponsableAprobacion=="" || entTareas.MailResponsableAprobacion == "NULL")
                { }
                else
                {
                    ...
                    ValorRes = EnviarMailOtros(entTareas.MailResponsableAprobacion, entTareas.MailAprobacionTitulo, EnvioActividad(entTareas.Num_OrdenServicio, entTareas.Nom_Empresa, entTareas.Nom_Responsable, entTareas.Det_Tarea, ValorIncritado1, ValorIncritado2, parametroConfiguracion.Valor.ToString(), entTareas.MailAprobacionTitulo));
                    if (ValorRes == true)
                    {
                        var Respuesta = 0;
        ...
        public string EnvioActividad(string numeroOrden,string empresa,string responsable, string tarea, string  valorIncritado1, string valorIncritado2, string urlSiteAprobacion, string DetalleAprobacion)
        {
            ...
            mensaje = mensaje + "<div align='center'><span style='font:Arial,Helvetica,sans-serif; font-size:16px; padding:10px; font-weight:bold; color:#030303'>"+ DetalleAprobacion + "</span></div>";
