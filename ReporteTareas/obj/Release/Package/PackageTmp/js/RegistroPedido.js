...
function ObtenerListaPedidosVisualizar(tipo, idRegistro, fechaInicio, fechaFinal) {
    ...
    var Datos = "[{ \"action\": \"ReporteListaPedidos\", \"parameters\" : { fechaDesde: \"" + fechaInicio + "\", fechaHasta: \"" + fechaFinal + "\", busqueda: \"" + $("#txtNumeroOrden2").val() + "\", IdCliente: \"" + idCliente2 + "\", IdGerenteCuenta: \"" + $("#cboVendedor2").val() + "\", IdGestorProducto: \"" + $("#cboGerente2").val() + "\", sucursal: \"" + selectedSucursal + "\", estado: \"" + $("#cboEstado2").val() + "\" , IdClasificacion: \"" + $("#cboClasificacion2").val() + "\", Anio: \"" + $("#cboAnio").val() + "\", meses: \"" + $("#cboMeses").val() + "\", idFecha: \"" + $("#cboFecha").val() + "\", IdRenovacion: \"" + chekRenovacionFiltrar + "\" } }]";
    //idCliente2 = 0;
...
function EliminarPedido() {
    ...
    datosFormulario = datosFormulario + "'txtFechaDesdeRenova': '" + $('#txtFechaDesdeRenova').val() + "',";
    datosFormulario = datosFormulario + "'txtFechaHastaRenova': '" + $('#txtFechaHastaRenova').val() + "',";
    datosFormulario = datosFormulario + "'checkIngreso': '" + "0" + "'";
