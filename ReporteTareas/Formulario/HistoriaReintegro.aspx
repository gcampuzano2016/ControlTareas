<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="HistoriaReintegro.aspx.cs" Inherits="ReporteTareas.Formulario.HistoriaReintegro" %>
<asp:Content ID="HistoriaReintegroContent" ContentPlaceHolderID="head" runat="server">
    <!-- Estilos -->
    ...
    <script src="../js/HistoriaReintegro.js?v=1"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     HistoriaReintegro.aspx.cs
                            ...
                            <div class="" style="">
                                ...
                                <div class="horizontal-group-special contenedor-horizontal" style="justify-content:flex-start; margin-top:0;">
                                    <div class="form-group col-sm-12" style="margin-bottom:0;">
                                        ...
                                        <textarea id="txtMotivoConsulta" rows="2" style="width: 100%; resize: vertical;" placeholder="Anotar la causa del problema en la versión del informante"></textarea>
                                    </div>
                                </div>

                                <div class="horizontal-group-special contenedor-horizontal" style="margin-top:0; margin-bottom: 2rem;">
