<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="AprobacionTareasRevisor.aspx.cs" Inherits="ReporteTareas.Formulario.AprobacionTareasRevisor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/aprobacionTareasRevisor.js?v=1" type="text/javascript"></script>
                                        ...
                                        <div class="col-lg-12">
                                            <form role="form">
                                                ...
                                                <div class="col-lg-12" id="divFrmTxtTareaPrincipalDescripcion">
                                                    ...
                                                    <textarea class="form-control" rows="2" cols="50" id="frmTxtTareaPrincipalDescripcion"  disabled   maxlength="30" placeholder="solo permite ingresar 30 Carácteres">
                                                    </textarea>
                                                    <p class="help-block"></p>
                                                </div>
