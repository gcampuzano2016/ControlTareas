...
function RecorreJSONTableDetail(json) {
    ...
    info = info + thInicial + "Aprobación Mensual QA" + thFinal;
    info = info + thInicial + "Aprobación Mensual Supervisor" + thFinal;
    ...
    $.each(json, function (i, item) {
        ...
        info = info + "<div class='" + item.Det_Aprobacion_Tarea_Estado_QA_Class_Mensaje + "'>" + item.Det_Aprobacion_Tarea_Estado_QA_Descripcion + "</div>";
        info = info + "</td>";

        info = info + "<td class='sorting_1'>";
        info = info + "<div class='" + item.Det_Aprobacion_Tarea_Estado_Class_Mensaje + "'>" + item.Det_Aprobacion_Tarea_Estado_Descripcion + "</div>";
        info = info + "</td>";
...
function AprobarTareas() {
    ...
    datos = "[{'action': 'AprobarTareaRevisor', 'parameters' : " + datosFormulario + " }]";
...
function AnularAprobacionTareas() {
    ...
    datos = "[{'action': 'AnularAprobacionTareasRevisor', 'parameters' : " + datosFormulario + " }]";
