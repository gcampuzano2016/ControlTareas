...
function ObtenerListaContratos(tipo, idRegistro, fechaInicio, fechaFinal) {
    var Datos = "[{ \"action\": \"ReporteListaContratos\", \"parameters\" : { fechaDesde: \"" + fechaInicio + "\", fechaHasta: \"" + fechaFinal + "\", busqueda: \"" + $("#txtNumeroOrden2").val() + "\", IdCliente: \"" + $("#cboCliente2").val() + "\", IdGerenteCuenta: \"" + $("#cboGerente2").val() + "\", IdGestorResponsable: \"" + $("#cboResponsable2").val() + "\", sucursal: \"" + $("#cboSucursal2").val() + "\", estado: \"" + $("#cboEstado2").val() + "\", area: \"" + $("#cboArea2").val() + "\" , IdClasificacion: \"" + '0' + "\" } }]";
