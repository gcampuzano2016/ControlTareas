<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="TiempoTarea.aspx.cs" Inherits="ReporteTareas.Formulario.TiempoTarea" %>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <asp:GridView ID="dgv_Tareas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="table-responsive table-striped table-bordered table-hover" AutoGenerateColumns="False" Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Det_Det_TareaFin" HeaderText="Detalle Tarea Final" Visible="False" />
                                            <asp:BoundField DataField="EstadoInicial" HeaderText="Estado Actual" />
                                            <asp:BoundField DataField="Motivo" HeaderText="Motivo Cambio" />
                                            <asp:BoundField DataField="Cod_Sap" HeaderText="Cod Sap" />
                                            <asp:BoundField DataField="OrdenOperacion" HeaderText="Orden Operacion" />
                                        </Columns>
                                    </asp:GridView>
                                </div>
                            </div>
