                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row" runat="server" id="Parte0" visible="true">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-3">
                                                    <h6>
                                                        <asp:Label ID="lblCliente" Text="Cliente" runat="server" CssClass="text-center"></asp:Label></h6>
                                        ...
                                        <%--                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <h6><asp:Label ID="lbl_Os" Text="N° de orden de servicio" runat="server" CssClass="text-center"></asp:Label></h6>
                                                            <asp:TextBox ID="txt_Os" runat="server" cssClass="form-control tam-text-box" Enabled="true"/>
