...
function ObtenerListaComboGerenteCuenta() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"42\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + "0" + "\"} }]";
    CargarPagina('#cboVendedor', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}

function ObtenerListaComboGerenteCuentaUnico1() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"43\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + "0" + "\"} }]";
    CargarPagina('#cboVendedor', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}
...
function ObtenerListaComboGerenteProducto() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"44\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + "0" + "\"} }]";
    CargarPagina('#cboGerente', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}

function ObtenerListaComboMarca() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"41\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + $("#ContentPlaceHolder1_txtIdCliente").val() + "\"} }]";
...
function ObtenerListaComboGerenteProductoUnico1() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"45\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + "0" + "\"} }]";
    CargarPagina('#cboGerente', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}
...
function ObtenerListaComboMarca2() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"46\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + $("#ContentPlaceHolder1_txtIdCliente").val() + "\"} }]";
    CargarPagina('#cboMarca2', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}

function ObtenerListaComboMarcaGerente() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"46\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"" + $("#cboGerente2").val() + "\", IdCliente: \"0\"} }]";
    CargarPagina('#cboMarca2', 'ObtenerListaTareas.ashx', Datos, "select", "", "");
}
...
function ObtenerListaComboSucursal1() {
    var Datos = "[{ \"action\": \"ListaComboContrato\", \"parameters\" : { \"Tipo\" : \"47\", session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\",\"IdSucursal\" : \"0\", IdCliente: \"" + $("#ContentPlaceHolder1_txtIdCliente").val() + "\"} }]";
...
function BuscarCliente2() {
    ...
    if ($('#cboCliente2').val().length > 2) {
        idSeleccionado = 0;
        ObtenerListaClientes(12, $('#cboCliente2').val(), 4);
    }
    else {
        idCliente = 0;
...
function ObtenerConsultarForeCast(idForeCast, tipo) {
    var Datos = "[{ \"action\": \"ReporteConsultarForeCastGD\", \"parameters\" : { idForeCast: \"" + idForeCast + "\", tipo: \"" + tipo + "\"} }]";
...
function ObtenerConsultarForeCastDetalleFiltros(idForeCast, tipo, fechaInicio, fechaFinal) {
    var Datos = "[{ \"action\": \"ReporteConsultarForeCastFiltrosGD\", \"parameters\" : { session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\", idForeCast: \"" + idForeCast + "\", FechaFacturacion: \"" + $("#cboFecha1Buscar").val() + "\", MesEstimadoCierre: \"" + "" + "\", IdCliente: \"" + idCliente2 + "\",IdGerenteCuenta: \"" + $("#cboVendedor2").val() + "\",IdGestorProducto: \"" + $("#cboGerente2").val() + "\",IdMarca: \"" + $("#cboMarca2").val() + "\",sucursal: \"" + $("#cboSucursal2").val() + "\",SegmentodeMercado: \"" + $("#cboSegmentacion2").val() + "\",IdPrioridad: \"" + $("#cboPrioridad2").val() + "\",mespago: \"" + $("#cboFecha2Buscar").val() + "\",tipofecha: \"" + $("#cboTipoFecha").val() + "\",anio: \"" + $("#cboAnio1").val() + "\",cierrenegocio: \"" + $("#cboCierreNegocio2").val() + "\"} }]";
...
function ObtenerConsultarForeCastDetalleFiltrosDescargar(idForeCast, tipo, fechaInicio, fechaFinal) {
    var Datos = "[{ \"action\": \"ReporteConsultarForeCastFiltrosDescargarGD\", \"parameters\" : { session: \"" + $("#ContentPlaceHolder1_txtUsuario").val() + "\", idForeCast: \"" + idForeCast + "\", FechaFacturacion: \"" + $("#cboFecha1Buscar").val() + "\", MesEstimadoCierre: \"" + "" + "\", IdCliente: \"" + idCliente2 + "\",IdGerenteCuenta: \"" + $("#cboVendedor2").val() + "\",IdGestorProducto: \"" + $("#cboGerente2").val() + "\",IdMarca: \"" + $("#cboMarca2").val() + "\",sucursal: \"" + $("#cboSucursal2").val() + "\",SegmentodeMercado: \"" + $("#cboSegmentacion2").val() + "\",IdPrioridad: \"" + $("#cboPrioridad2").val() + "\",mespago: \"" + $("#cboFecha2Buscar").val() + "\",tipofecha: \"" + $("#cboTipoFecha").val() + "\",anio: \"" + $("#cboAnio1").val() + "\",cierrenegocio: \"" + $("#cboCierreNegocio2").val() + "\"} }]";
...
function dtUsers(json) {
    ...
    table = $('#table-users').DataTable({
        data: json,
        columns: [
            { defaultContent: "<button type='button' value='Actualizar' title='Editar Oportunidad' class='btn btn btn-editClientes btn-xs'><i class='fa fa-edit' aria-hidden='true'></i></button>" },
            { data: 'Marca' },
            { data: 'Cliente' },
...
function GuardarNuevoForeCast() {
    ...
    if (IdGuardar == 1) {
        ...
        datos = "[{'action': 'GuardarNuevoForecastGD', 'parameters' : " + datosFormulario + " }]";
...
function ActualizarForeCast() {
    ...
    datos = "[{'action': 'GuardarNuevoForecastDG', 'parameters' : " + datosFormulario + " }]";
...
function GuardarCliente() {
    ...
    if ($('#txtObservacionReq').val() == "") {
        ...
        if (tipo == 5) {
            ...
            datos = "[{'action': 'GuardarNuevoClienteGD', 'parameters' : " + datosFormulario + " }]";
...
$(function () {
    ...
    if ($("#ContentPlaceHolder1_txtIdTipo").val() == "8" || $("#ContentPlaceHolder1_txtIdTipo").val() == "19") {
    ...
    else if ($("#ContentPlaceHolder1_txtIdTipo").val() == "20")
    {
        ObtenerListaComboGerenteCuentaUnico1();
        ObtenerListaComboGerenteCuentaUnico2();
        ObtenerListaComboGerenteProducto();
    ...
    if ($("#ContentPlaceHolder1_txtIdTipo").val() == "10" || $("#ContentPlaceHolder1_txtIdTipo").val() == "12") {
