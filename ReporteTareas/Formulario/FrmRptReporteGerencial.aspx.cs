...
{
    public partial class FrmRptReporteGerencial : System.Web.UI.Page
    {
        #region Variables
        protected NegCRedireccionamientoLogin GetLogin = new NegCRedireccionamientoLogin();
        #endregion
        protected void Page_Load(object sender, EventArgs e)
        {
            GetLogin.RedireccionarALogin(this);
            if (Session["UserLogin"] != null)
            {
                ...
                TextBox1.Text = CodUnico.ToString();
