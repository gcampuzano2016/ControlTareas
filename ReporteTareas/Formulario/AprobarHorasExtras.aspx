                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <asp:GridView ID="dgv_Tareas" runat="server" CssClass="table table-striped table-bordered table-hover table-responsive" AutoGenerateColumns="False" Width="100%" OnSelectedIndexChanged="dgv_Tareas_SelectedIndexChanged" OnRowCommand="dgv_Tareas_RowCommand" OnRowEditing="dgv_Tareas_RowEditing">
