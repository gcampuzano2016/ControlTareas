<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="RegistroAsistencia.aspx.cs" Inherits="ReporteTareas.Formulario.RegistroAsistencia" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css" rel="stylesheet" />
    <script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>

    <script src="../js/registroAsistencia.js?v=6" type="text/javascript"></script>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills">
                            <li class="active" id="tab1"><a href="#home-pills" data-toggle="tab">Registro de Asistencia</a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer">
                                        <div class="" style="text-align: center">
                                            ...
                                            <button id="btnAgregar" onclick="BtnAgregarAsistencia()" type="button" class="btn btn-primary">Agregar Asistencia</button>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <div>
                                                    ...
                                                    <h4 class="" id="listPrincipalTitleLabel">Resumen del Total de Asistencias Por Día</h4>
                                                </div>
                                            </div>
                                            <!-- /.panel-heading -->
