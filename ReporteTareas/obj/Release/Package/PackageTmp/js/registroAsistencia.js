...
function GuardarAsistencia(IdProceso) {
    ...
    datos = "[{'action': 'RegistrarEvento2', 'parameters' : " + datosFormulario + " }]";
...
function RecorreJSONTable(json) {
    ...
    $.each(json, function (i, item) {
        ...
        // 
        if (esImpar) {
            info = info + "<tr class='gradeA odd' role = 'row' id='tr-" + item.IdProceso + "'>";
            esImpar = false;
        } else {
            info = info + "<tr class='gradeA even' role = 'row' id='tr-" + item.IdProceso + "'>";
            esImpar = true;
        }
        info = info + "<td class='sorting_1' style='text-align:center'>";
        info = info + "<i class='fa fa-eye' style='cursor: pointer' onclick='EditarAsistencia(\"" + item.IdProceso + "\",\"" + item.FechaEntrada + "\",\"" + item.FechaSalida + "\");'></i>";
        info = info + "</td > ";
        info = info + "<td class='sorting_1'>" + item.Nom_Usuario + "</td>";
        info = info + "<td class='sorting_1' style='text-align: center;'>" + item.FechaEntrada + "</td>";
        info = info + "<td class='sorting_1' style='text-align: center;'>" + item.FechaSalida + "</td>";
        info = info + "<td class='sorting_1' style='text-align: center;'>" + item.Dia + "</td>";
        info = info + "<td class='sorting_1' style='text-align: center;'>" + item.HorasTotal + "</td>";
