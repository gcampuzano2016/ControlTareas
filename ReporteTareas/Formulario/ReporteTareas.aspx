<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="ReporteTareas.aspx.cs" Inherits="ReporteTareas.Formulario.ReporteTareas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/reporteTareas.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12" style="padding: 0px">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <label>Fecha desde Aprobación Jefe:</label>
                                    <input type="text" class="form-control" id="txtFechaDesdeAprobacion">
                                    <p class="help-block"></p>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Fecha Hasta Aprobación Jefe:</label>
                                    <input type="text" class="form-control" id="txtFechaHastaAprobacion">
                                    <p class="help-block"></p>
                                </div>
                                <div class="form-group col-lg-4">
                                            <label>Estado Aprobación Jefe</label>
                                            <select id="cmbEstadoAprobacionJefe" class="form-control">
                                            </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <label>Fecha desde Aprobación QA:</label>
                                    <input type="text" class="form-control" id="txtFechaDesdeAprobacionQA">
                                    <p class="help-block"></p>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label>Fecha Hasta Aprobación QA:</label>
                                    <input type="text" class="form-control" id="txtFechaHastaAprobacionQA">
                                    <p class="help-block"></p>
                                </div>
                                <div class="form-group col-lg-4">
                                            <label>Estado Aprobación QA</label>
                                            <select id="cmbEstadoAprobacionQA" class="form-control">
                                            </select>
                                </div>
                            </div>                            <div class="row">
