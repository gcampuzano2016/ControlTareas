<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="ReporteCumplimientoDiario.aspx.cs" Inherits="ReporteTareas.Formulario.ReporteCumplimientoDiario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/reporteCumplimientoDiario.js" type="text/javascript"></script>
