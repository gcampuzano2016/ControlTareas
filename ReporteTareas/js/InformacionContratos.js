...
//// Funcion para cambiar de color del titulo redondo seleccionado
...
//    var fileData = new FormData();
//    fileData.append('session', $("#ContentPlaceHolder1_txtUsuario").val());
//    fileData.append('action', 'AbrirDocArchivo');
//    fileData.append('Id_RegTareas', 0);
//    fileData.append('idServicio', "1");
//    fileData.append('nombreArchivo', nombreArchivo);
//    fileData.append('nombreCarpeta', nombreCarpeta);
...
//        },
//        error: function () {
//            var mensajeError = "La acción está tomando demasiado tiempo, la red podría estar saturada. Vuelva a intentarlo en unos segundos.";
