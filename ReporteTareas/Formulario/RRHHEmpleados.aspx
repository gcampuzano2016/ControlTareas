<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="RRHHEmpleados.aspx.cs" Inherits="ReporteTareas.Formulario.RRHHEmpleados" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css" rel="stylesheet" />
    <script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>

    <script src="../js/Empleados.js?v=5"></script>
    ...
    <div id="page-wrapper" style="padding: 0px">
        <div class="col-lg-12" style="padding: 0px">
            ...
            <asp:Panel ID="Panel5" runat="server" Visible="true" Enabled="true">
                ...
                <div class="col-lg-12" style="display: none" id="editBotonCargaFam">
                    <div class="col-xs-12">
                        <div class="text-left">
                            ...
                            <button type="button" title="Cargar Documentos" class="btn btn-info btn-sm " onclick="MensajeListaArchivos()">Documentos</button>                           
                ...
                <!-- Modal -->
                <div id="msgVerArchivos" class="modal fade" role="dialog">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <label for="banner">Documentos:</label>
                            </div>
                             
                            <div class="box box-primary">
                                <div class="table-responsive">
                                    <table id="tbl_Archivos" class="table table-bordered table-hover text-center" style="border-color: #808080; font-size:85%;">
                                        <thead class="bg-primary">
                                          <tr>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-default alert-warning" data-dismiss="modal">Volver</button>
                                
                                <button type="button" title="Cargar Documentos" class="btn btn-info btn-sm " onclick="MensajeCargaArchivo()">
                                    <i class="fa fa-files-o margin-right"></i> Cargar Documentos
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div id="msgCargarArchivos" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Cargue los documentos de sus familiares por favor.</p>
                                 <formview action="/action_page.php">
                                      <label for="myfile">Selecccion archivo:</label>
