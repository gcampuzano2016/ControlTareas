...
function ObtenerListaTareasHorasExtras(tipo, idRegistro) {
    var Datos = "[{ \"action\": \"ReporteGPFGeneradas\", \"parameters\" : { fechaDesde: \"" + $("#txtFechaDesde").val() + "\", fechaHasta: \"" + $("#txtFechaHasta").val() + "\"} }]";
...
function ObtenerListaHorasExtrasDescarga(tipo, idRegistro) {
    var Datos = "[{ \"action\": \"ReporteGPFDescargaXLS\", \"parameters\" : { fechaDesde: \"" + $("#txtFechaDesde").val() + "\", fechaHasta: \"" + $("#txtFechaHasta").val() + "\", idtipo: \"" + $("#cboreporte").val() + "\"} }]";
