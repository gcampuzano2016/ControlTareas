<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="ReporteGPF.aspx.cs" Inherits="ReporteTareas.Formulario.ReporteGPF" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/ReportesGPF.js?v=1" type="text/javascript"></script>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <select id="cboreporte" class="form-control">
                                    <option value="0">SELECCIONAR</option>
                                    <option value="1">Reporte GPF</option>
                                    <option value="2">Encuesta GPF</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
