<%@ Page Title="" Language="C#" MasterPageFile="~/Formulario/Master.Master" AutoEventWireup="true" CodeBehind="ValidarTareas.aspx.cs" Inherits="ReporteTareas.Formulario.ValidarTareas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/ValidarTarea.js" type="text/javascript"></script>
